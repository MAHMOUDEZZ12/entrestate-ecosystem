...
export function WhatsMAPEngine() {
    ...
    const [messages, setMessages] = useState([
        { from: 'bot', components: [{ type: 'text', data: { text: "Welcome to the WhatsMAP Engine. How can I help you orchestrate your next move?" } }] }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const errorResponse = { from: 'bot', components: [{ type: 'text', data: { text: "An error occurred. Please try again." } }] };
